...
import { fetchLatestSnapshot, fetchHistoryIndex, fetchCommodities, fetchMagaData, fetchComposite, fetchHoldings, fetchPnl, fetchSensitivity, fetchExitAlerts, fetchUserHoldings, fetchStockNames } from "@/lib/fetcher";
...
export default async function DashboardPage() {
  const [snapshot, historyIndex, commodities, magaData, composite, sensitivity, holdings, pnl, exitAlerts, userHoldings, stockNames] = await Promise.all([
    fetchLatestSnapshot(),
    fetchHistoryIndex(),
    fetchCommodities(),
    fetchMagaData(),
